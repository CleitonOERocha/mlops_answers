...
def tratamento_dataset(df_train, df_val):
    ...
    return X_train, X_val, y_train, y_val, train, valid

##########################################################################
# Rodando com os melhores parâmetros selecionados anteriormente no mlflow ----------------------
##########################################################################

def train_model_xgboost(X_train, X_val, y_train, y_val, train, valid):
...
def run_model(experiment_name):
    ...
    X_train, X_val, y_train, y_val, train, valid = tratamento_dataset(df_train, df_val)

    # Criando um artefato (eles servem para reproduzir o modelo) ----------------
    #with open("preprocessor.b", "wb") as f_out:
        
    y_pred, rmse, booster = train_model_xgboost(X_train, X_val, y_train, y_val, train, valid)
