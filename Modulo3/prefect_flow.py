...
#pip install --force-reinstall prefect==2.0b5
...
def train_best_model(train, valid, y_val, dv):
    with mlflow.start_run():
        ...
        # Criando artefato do modelo ---------------------------------
        # log_model salva todas as informações para aplicar o código em novos dados
...
""" 
train_path = "green_tripdata_2021-01.parquet",
